...
for(const script of ['input','gameplay','combat','ai'])
  assert.match(index,new RegExp(`js/${script}\\.js\\?v=20260830-sniper-fire-v1`),`${script}.js needs the Sniper fix cache-buster`);
