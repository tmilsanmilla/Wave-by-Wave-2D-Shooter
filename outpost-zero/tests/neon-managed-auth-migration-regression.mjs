...
assert.match(networking, /Your account and game data are restored/);
assert.match(networking, /reason:'reset-sent'/);
...
assert.match(index, /YOUR DATA IS SAFE/);
assert.match(index, /networking\.js\?[^"']*release=20260925-better-auth-restore-v2/);
