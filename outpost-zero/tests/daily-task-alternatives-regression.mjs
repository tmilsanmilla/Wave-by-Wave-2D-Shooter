...
for(const [script,version] of [['networking','20260831-hub-tools-settings-v1'],['administration','20260831-unresolved-report-copy-v1'],
...
for(const script of ['party'])
  assert.match(index,new RegExp(`js/${script}\\.js\\?v=20260831-melee-polish-v1`),`${script}.js needs the current CPU cache-buster`);
for(const [script,version] of [['gameplay','20260831-tracking-drill-v1'],['combat','20260831-melee-polish-v1'],
