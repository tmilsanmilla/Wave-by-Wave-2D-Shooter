...
const WEAPONS = {
  ...
  revolver:{ name:'.357 PYTHON',  dmg:70,  mag:8,  reload:1500, fireRate:850, auto:false, pellets:1, fg:5,
             ...
             fan:true, fanExtraShots:5, fanGapMs:115, fanLockMs:900, fanDmgMul:0.60,
             gimmick:{id:'python_fan_the_hammer',copy:'Aim to fan up to five extra shots at 60% damage, using real ammo.'},
             blurb:'Heavy hip-fire, or aim to fan six scaled shots using real ammo.' },
  ...
  volt   : { name:'VOLT PISTOL',  dmg:24,  mag:7,  reload:750,  fireRate:145, auto:false, pellets:1, fg:4,
             ...
             gimmick:{id:'volt_bottomless_cell',copy:'Infinite reserve and no damage falloff at any range; reload its seven-round cell.'},
             blurb:'Bottomless reserve and no range falloff; reload its tiny seven-round cell.' },
  ...
  fireworks:{ name:'FIREWORK LAUNCHER', dmg:0, mag:8,  reload:1900, fireRate:520, auto:false, pellets:1,
             ...
             moveMod:1.0, range:620, fall:1, sndF:700, sndD:0.05, shotSfx:'fireworks',
             gimmick:{id:'firework_airburst',copy:'Fixed-fuse shot bursts at the crosshair, dealing an incendiary blast.'},
  ...
  twinsai: { name:'TWIN SAI',      melee:true, dmg:22, mag:Infinity, reload:0, fireRate:150, auto:true,
             ...
             gimmick:{id:'twin_sai_parry',copy:'Alternating dual slashes; Parry reflects the next incoming shot.'},
  ...
  bdaggers:{ name:'BURNING DAGGERS', melee:true, dmg:34, mag:Infinity, reload:0, fireRate:340, auto:true,
             ...
             gimmick:{id:'burning_daggers_return',copy:'Alternating burning blades; Hurl sends both out and back.'},
...
const UTILITIES = {
  ...
  freezer: { name:'FREEZER',      cd:25000,
             gimmick:{id:'freezer_brittle_stasis',copy:'Freezes a wide area; frozen targets take half damage and the first hit thaws them.'},
