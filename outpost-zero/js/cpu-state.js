...
let selPage='hub', pendingGameMode=null, modeBoardMode=null, modeBoardOrigin='hub', loadoutBackPage='modeboard', modeBoardActionRects=[], offlineCpuRects=[], rankedRects=[], catBtns=[], modeRects=[], homePlayRects=[], partyRects=[], partyModeRects=[], toolsRects=[], backRect=null, tempBtnRect=null, tutBtnRect=null, settingsBtnRect=null, toolsBtnRect=null, diffRects=[], shopBtnRect=null, shopRects=[], shopTab='weapons', shopTabRects=[], shopCosWeapon=null, shopWeaponPickerOpen=false, shopWeaponPickerTarget='cosmetics', shopWeaponPickerCat='primary', shopWeaponPickerRects=[], pendingCancelRect=null;   // + weapons | weaponbrowse | modeboard | offlinecpu | ranked | loadout | social | party | partymodes | tools | tutorial | shop
